...
scenario = NCScenarioLoader(dataset_name='ogbn-products', num_tasks=9, metric='accuracy', save_path='data', incr_type='class', task_shuffle=1)
model = GCNNode(scenario.num_feats, scenario.num_classes, 256, dropout=0.0)
benchmark = NCClassILEWCMinibatchTrainer(model = model,
                                scenario = scenario,
                                ...
                                benchmark = True, seed = 42, lamb=10000.0)
